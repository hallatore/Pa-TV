...
namespace Pa_TV.Contracts
{
    ...
    /// </summary>
    public sealed partial class SearchResultsPage : Pa_TV.Common.LayoutAwarePage
    {
        private Dictionary<string, List<Event>> _results = new Dictionary<string, List<Event>>();
        ...
        /// </summary>
        private sealed class Filter : Pa_TV.Common.BindableBase
        {
